...
cl = LINETCR.LINE()
cl.login(token="ErmLJpALM76KAql4t3J4.0zpfo2aP7UUoLGpPuuUXva.iSvsx0151iq8Iqgjc7+wcnFFD93nImb9QecDVbMaW3E=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="ErCHr17qXoTNvZ5e3325.7JiFlip/2seHVY0cM/ZtXq.Bdzc/Tz2l6E6pFOyQdSkmyllUeFVF2/g2xro7mGdulI=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EreS5mbIa8EPXUqe1LPd.3tFUCGM2QiHoj8Nu8SWkdq.bNGBTMubABCvjXbJLwMX2RT3M63r3gWfNEpShP+bRkA=")
ki2.loginResult()
...
║╠[33]Masuk
║╠[34]Keluar
║╠[35]salken om (buat kick semua anggota)
║║★And More★
║╚════════════
║𖤓≛≛≛≛≛≛≛≛≛≛≛≛≛𖤓
║     ૦Ո૯  ც૦੮
...
owner =["ud193c53b6029eeeb8e9603e9514bb154"]
admin = ["ud193c53b6029eeeb8e9603e9514bb154"]
wait = {
    'contact':False,
    'autoJoin':True,
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
              ...
              ##if msg.from_ in admin:
                ...
                ki.sendText(msg.to,"----Dari Indonesia----\n" + "" + kata + "\n\n----Ke Inggris----\n" + "" + result)
                ...
                result = page[page.find(cari_hasil)+len(cari_hasil):]
                result = result.split("<")[0]
                ki.sendText(msg.to,"----Dari Inggris----\n" + "" + kata + "\n\n----Ke Indonesia----\n" + "" + result)
                ...
                result = page[page.find(cari_hasil)+len(cari_hasil):]
                result = result.split("<")[0]
                ki.sendText(msg.to,"----Dari Thailand----\n" + "" + kata + "\n\n----Ke Indonesia----\n" + "" + result)       
...
#-------------------- Protect Mode ------------
                ...
                if wait["Protectjoin"] == False:
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Kick Joined Gtoup Off�")
                else:
                    wait["Protectjoin"] = False
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Udah Mati Gblk")
                    else:
                        ki.sendText(msg.to,"Udah Mati Gblk")
...
#----------------------------------------------
                ...
                if wait["Protectcancl"] == True:
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Cancel Semua Undangan On")
                    else:
                        ki.sendText(msg.to,"done")
                else:
                    wait["Protectcancl"] = True
                ...
                if wait["Protectcancl"] == False:
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Cancel Semua Undangan Off")
                    else:
                        ki.sendText(msg.to,"done")
                else:
                    wait["Protectcancl"] = False
                ...
                if wait["Protectcancel"] == True:
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Yang Cancel Undangan Kami Kick")
                    else:
                        ki.sendText(msg.to,"done")
                else:
                    wait["Protectcancel"] = True
                ...
                if wait["Protectcancel"] == False:
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Yang Cancel Undangan Tidak Kami Kick")
                    else:
                        ki.sendText(msg.to,"done")
                else:
                    wait["Protectcancel"] = False
                ...
                if wait["Protectgr"] == False:
                    if wait["lang"] == "JP":
                        kj.sendText(msg.to,"Protect QR Off")
                    else:
                        ki.sendText(msg.to,"done")
                else:
                    wait["Protectgr"] = False
                ...
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Cek Mid Lewat Share Kontak On")
                    else:
                        ki.sendText(msg.to,"done")
                else:
                    wait["contact"] = True
                ...
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Cek Mid Lewat Share Kontak Off")
                    else:
                        ki.sendText(msg.to,"done")
                else:
                    wait["contact"] = False
...
#--------===---====--------------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
              ...
              #if msg.from_ in admin:
                ki.sendText(msg.to, "Cek Sider PPQ")
                try:
                ...
                #print wait2
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        ki.sendText(msg.to, "||Di Read Oleh||%s\n||By : ✰Alwan ら૯ՆԲც૦੮✰||\n\n>Sider PPQ<\n%s-=Tukang Sider=-\n•Bintitan\n•Panuan\n•Kurapan\n•Kudisan\n\n\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        ki.sendText(msg.to, "Ketik Cctv dulu Koplak\nBaru Ketik Ciduk\nDASAR PIKUN ♪")
#-----------------------------------------------
...
#-----------------------------------------------
    ...
    #-------------Fungsi Tag All Start---------------#
            elif msg.text in ["Tag all","Tagall","tag"]:
    ...
    #-------------------------------------------------#
        ...
        #-----------------------------------------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    gs = ki.getGroup(msg.to)
                    gs = ki2.getGroup(msg.to)
                    ki.sendText(msg.to,"Hello Kk")
                    ki.sendText(msg.to," Mau Bersih²  Nih")
                    ki.sendText(msg.to,"Jadi Mau Di Bersihin Dulu Yah\n★Jangan Baper...\n★Jangan Nangis\n★Jangan Cengeng\nBawa Enjoy Aja Kawan♪")
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': 'uc9363b5a4bfacd981c3e3c082bc4d5ef'}
                    ki.sendMessage(msg)
                    ki.sendText(msg.to,"Maapp ya Pak")
                    targets = []
                    for g in gs.members:
        ...
        #-------------Fungsi Spam Start---------------------#
                ...
                ki2.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                ki.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                ki2.sendText(msg.to,"KNTL KALEAN")
        #-------------Fungsi Spam Finish---------------------#
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
                ...
                ki.sendText(msg.to,"Bot Alwan Hadir ")
                ki2.sendText(msg.to,"Bot Alwan Hadir")
                ki.sendText(msg.to,"Semua Udah Hadir Boss\nSiap Protect Group\nAman Gak Aman Yang Penting Berkah")
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
                ...
                start = time.time()
                ki.sendText(msg.to, "Menghitung Kecepatan...")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              ki.sendMessage(msg)
              ki.sendText(msg.to,"======================")
              ki.sendText(msg.to,"Itu Creator Kami")
...
#---------------------
        if op.type == 17:
          ...
          #ki.sendText(op.param1, "Founder Grup " + str(ginfo.name) + " :\n" + ginfo.creator.displayName)
          #ki.choice(KAC).sendText(op.param1,"Budayakan Baca Note !!! yah Ka 😊\nSemoga Betah Kk 😘")
